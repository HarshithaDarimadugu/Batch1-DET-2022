...
namespace BATCH1_DET_2022
{
    public class Classmain1
    {
        ...
        public static void Main()
        {
            ...
            ScienceStudent sciencesubject = new ScienceStudent { physics = 89, chemistry = 90, maths = 94};
            CommerceStudent Commercessubject = new CommerceStudent { economices = 60, accounts = 89, banking = 56 };
